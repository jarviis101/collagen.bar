	...
	<section class="container-fluid" id="inner-product-tabs-section">
		<div class="container">
			<div class="row">
			  ...
			  <ul class="d-flex flex-column flex-sm-column flex-md-row flex-lg-row flex-xl-row">
			    ...
			    <div class="d-flex flex-row justify-content-around">
                    ...
                    @else
                        <div class="row justify-content-center align-items-center">
                            <h1 class="py-5">В этому продукте нет дополнительных картинок</h1>
                        </div>
                    @endif
                </div>
			  </div>
