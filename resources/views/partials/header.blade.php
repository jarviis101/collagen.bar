<div class="mask">
    <div class="nav-menu" id="navbar-menu-md">
        <ul class="nav-list">
            <li class="nav-item col-12 col-sm-5 col-md-5">
...
<nav class="navbar navbar-dark justify-content-between justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-start" id="menu">
    <div class="container-fluid">
        ...
        <a class=" d-xl-none d-lg-none d-md-flex d-sm-flex d-flex ml-0 ml-sm-0 ml-md-0 ml-lg-0 ml-xl-5 button-nav-md">
            <i class="fas fa-bars"></i>
        </a>
